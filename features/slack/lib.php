...
class Slack
{
    ...
    function get_user_list()
    {
        ...
        $apiResult = $this->curlClient->get('https://slack.com/api/users.list', array('token' => $this->oAuthToken));
    ...
    function get_channel_messages_for_datetime_range($starttime, $endtime, $channel_id)
    {
        ...
        while ($fetch) {
            ...
            $fetchCounter++;
            $apiResult = $this->curlClient->get('https://slack.com/api/conversations.history', $queryParam);
    ...
    static function delete_channel($id, $conn = null)
    {
        ...
        return Persistence::flag_as_deleted('slack', 'id', $id, $conn);
    }
