...
class Contact
{
     ...
     * config.
     *
     * @param $username - the username to substitute in the lookup_url
     ...
     *
     * @param string $username - the username to substitute in the lookup_url
     *
     * @return string $username or <a href="lookup_url" target="_new">$username</a>
     */
